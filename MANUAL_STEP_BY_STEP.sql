-- =========================================================
-- SCRIPT QUE FUNCIONA DE VERDAD - EJECUTAR PASO A PASO
-- =========================================================
-- Ejecuta cada bloque por separado para evitar errores
-- =========================================================

-- BLOQUE 1: CREAR SOLO LA TABLA PRINCIPAL
...
-- BLOQUE 2: VERIFICAR QUE LA TABLA SE CREÓ
-- Ejecuta esto después del BLOQUE 1
SELECT 'Tabla purchase_transactions creada' as resultado;

-- BLOQUE 3: VERIFICAR QUE LA COLUMNA payment_deadline EXISTE
-- Ejecuta esto después del BLOQUE 2
SELECT column_name, data_type 
FROM information_schema.columns 
WHERE table_name = 'purchase_transactions' 
AND column_name = 'payment_deadline';

-- BLOQUE 4: CREAR TABLA TRANSACTION_STEPS
-- Ejecuta esto después del BLOQUE 3
...
-- BLOQUE 5: CREAR TABLA TRANSACTION_DOCUMENTS
-- Ejecuta esto después del BLOQUE 4
...
-- BLOQUE 6: CREAR TABLA TRANSACTION_NOTIFICATIONS
-- Ejecuta esto después del BLOQUE 5
...
-- BLOQUE 7: CREAR TABLA TRANSACTION_DISPUTES
-- Ejecuta esto después del BLOQUE 6
...
-- BLOQUE 8: CREAR ÍNDICES
-- Ejecuta esto después del BLOQUE 7
...
-- BLOQUE 9: CREAR FUNCIÓN VALIDATE_STATUS_TRANSITION
-- Ejecuta esto después del BLOQUE 8
...
-- BLOQUE 10: CREAR FUNCIÓN CREATE_PURCHASE_TRANSACTION
-- Ejecuta esto después del BLOQUE 9
...
-- BLOQUE 11: CREAR FUNCIÓN UPDATE_TRANSACTION_STATUS
-- Ejecuta esto después del BLOQUE 10
...
-- BLOQUE 12: CREAR FUNCIÓN CLEANUP_EXPIRED_TRANSACTIONS
-- Ejecuta esto después del BLOQUE 11
...
-- BLOQUE 13: CREAR TRIGGERS
-- Ejecuta esto después del BLOQUE 12
...
-- BLOQUE 14: CONFIGURAR RLS
-- Ejecuta esto después del BLOQUE 13
...
-- BLOQUE 15: VERIFICACIÓN FINAL
-- Ejecuta esto después del BLOQUE 14
...
-- INSTRUCCIONES:
-- =========================================================
-- 1. Ejecuta el BLOQUE 1 primero
-- 2. Si funciona, ejecuta el BLOQUE 2
-- 3. Si funciona, ejecuta el BLOQUE 3
-- 4. Si ves que payment_deadline existe, continúa con el BLOQUE 4
-- 5. Continúa ejecutando cada bloque por separado
-- 6. Si algún bloque falla, dime cuál y qué error da
-- =========================================================
