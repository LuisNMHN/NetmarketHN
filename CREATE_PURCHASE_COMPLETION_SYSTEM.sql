-- =========================================================
-- SISTEMA DE COMPLETAR COMPRA - NMHN
-- =========================================================
-- Sistema completo para cerrar el ciclo de compra con:
-- - Flujo de transacción con estados
-- - Sistema de escrow/protección de fondos
-- - Integración con chat y reputación
-- - Subida de comprobantes
-- - Temporizadores y notificaciones
-- =========================================================

-- =========================================================
-- 1. TABLA DE TRANSACCIONES DE COMPRA
-- =========================================================
...
-- =========================================================
-- 2. TABLA DE PASOS DE TRANSACCIÓN
-- =========================================================
...
-- =========================================================
-- 3. TABLA DE DOCUMENTOS DE TRANSACCIÓN
-- =========================================================
...
-- =========================================================
-- 4. TABLA DE NOTIFICACIONES DE TRANSACCIÓN
-- =========================================================
...
-- =========================================================
-- 5. TABLA DE DISPUTAS DE TRANSACCIÓN
-- =========================================================
...
-- =========================================================
-- 7. FUNCIONES PARA MANEJAR TRANSACCIONES
-- =========================================================
...
BEGIN
    ...
    INSERT INTO purchase_transactions (
        ...
        v_request_data.amount, -- Por ahora asumimos 1:1
        p_payment_method,
        p_payment_details,
        'agreement_confirmed',
        v_payment_deadline,
    ...
    INSERT INTO transaction_steps (transaction_id, step_name, step_order, step_description, status) VALUES
    (v_transaction_id, 'confirm_agreement', 1, 'Verificar el importe y el método de pago', 'completed'),
    (v_transaction_id, 'payment_in_progress', 2, 'Realizar el pago antes de que expire el temporizador', 'in_progress'),
    (v_transaction_id, 'verify_receipt', 3, 'Verificar el comprobante de pago', 'pending'),
    (v_transaction_id, 'release_funds', 4, 'Liberar los fondos al vendedor', 'pending');
    ...
    INSERT INTO transaction_notifications (transaction_id, user_id, notification_type, title, message) VALUES
    (v_transaction_id, v_request_data.buyer_id, 'payment_deadline_warning', 'Pago pendiente', 'Tienes 24 horas para completar el pago'),
    (v_transaction_id, p_seller_id, 'payment_received', 'Transacción iniciada', 'El comprador ha confirmado la transacción');
...
-- NOTAS IMPORTANTES:
-- =========================================================
-- 1. El sistema maneja el flujo completo de compra con protección de fondos
-- 2. Incluye temporizadores para deadlines de pago
-- 3. Sistema de pasos con estados claros
-- 4. Integración con sistema de documentos y comprobantes
-- 5. Notificaciones automáticas para cada cambio de estado
-- 6. Sistema de disputas para resolución de conflictos
-- 7. RLS habilitado para seguridad
-- 8. Triggers para actualización automática de timestamps
-- =========================================================
