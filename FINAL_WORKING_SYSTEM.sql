-- =========================================================
-- SCRIPT QUE MANEJA CONSTRAINTS EXISTENTES
-- =========================================================
-- Este script verifica si los constraints existen antes de crearlos
-- =========================================================

-- PASO 1: ELIMINAR TABLAS EXISTENTES SI HAY PROBLEMAS
DROP TABLE IF EXISTS transaction_disputes CASCADE;
DROP TABLE IF EXISTS transaction_notifications CASCADE;
...
-- PASO 2: CREAR TABLA PURCHASE_TRANSACTIONS SIN CONSTRAINTS PROBLEMÁTICOS
...
-- PASO 3: AGREGAR CONSTRAINTS DESPUÉS DE CREAR LA TABLA
...
SELECT 'Tabla purchase_transactions creada correctamente' as resultado;

-- PASO 4: VERIFICAR QUE LA COLUMNA payment_deadline EXISTE
...
SELECT 'Índices de purchase_transactions creados' as resultado;

-- PASO 6: CREAR TABLA TRANSACTION_STEPS
...
SELECT 'Tabla transaction_steps creada correctamente' as resultado;

-- PASO 7: CREAR TABLA TRANSACTION_DOCUMENTS
...
SELECT 'Tabla transaction_documents creada correctamente' as resultado;

-- PASO 8: CREAR TABLA TRANSACTION_NOTIFICATIONS
...
SELECT 'Tabla transaction_notifications creada correctamente' as resultado;

-- PASO 9: CREAR TABLA TRANSACTION_DISPUTES
...
SELECT 'Tabla transaction_disputes creada correctamente' as resultado;

-- PASO 10: CREAR ÍNDICES ADICIONALES
...
SELECT 'Todos los índices creados' as resultado;

-- PASO 11: CREAR FUNCIONES
...
-- PASO 12: CREAR FUNCIÓN CREATE_PURCHASE_TRANSACTION
...
-- PASO 13: CREAR FUNCIÓN UPDATE_TRANSACTION_STATUS
...
-- PASO 14: CREAR FUNCIÓN CLEANUP_EXPIRED_TRANSACTIONS
