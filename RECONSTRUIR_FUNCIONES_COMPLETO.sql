-- =========================================================
-- NMHN - ELIMINACIÓN AGRESIVA DE FUNCIONES
-- =========================================================
-- Script para eliminar TODAS las funciones relacionadas con purchase_requests
-- y recrearlas desde cero con códigos inteligentes
-- =========================================================

-- 1. Verificar TODAS las funciones relacionadas
SELECT 
    routine_name,
    routine_type,
    data_type,
...
WHERE routine_name LIKE '%purchase_request%'
AND routine_schema = 'public'
ORDER BY routine_name, specific_name;

-- 2. ELIMINAR TODAS las funciones relacionadas (sin excepciones)
...
DROP FUNCTION IF EXISTS debug_create_purchase_request CASCADE;
...
-- 5. Crear función create_purchase_request (desde cero)
...
-- 6. Crear función get_purchase_request_by_code (desde cero)
...
-- 7. Verificar que solo existen las funciones necesarias
SELECT 
    routine_name,
    routine_type,
    data_type,
...
1. ✅ Eliminadas TODAS las funciones relacionadas
2. ✅ Recreadas desde cero sin conflictos
3. ✅ Códigos inteligentes implementados
4. ✅ Sin ambigüedad en nombres

FUNCIONES CREADAS:
- generate_unique_code_safe()
- create_purchase_request()
- get_purchase_request_by_code()
