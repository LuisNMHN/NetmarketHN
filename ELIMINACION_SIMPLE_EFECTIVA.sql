-- =========================================================
-- NMHN - ELIMINACIÓN SIMPLE Y EFECTIVA
-- =========================================================
-- Script simple que evita problemas con OID y elimina funciones duplicadas
-- =========================================================
...
-- 2. ELIMINACIÓN SIMPLE POR NOMBRE (evita problemas con OID)
-- Eliminar todas las versiones de create_purchase_request
DROP FUNCTION IF EXISTS public.create_purchase_request CASCADE;
DROP FUNCTION IF EXISTS create_purchase_request CASCADE;

-- Eliminar todas las versiones de generate_unique_code_safe
DROP FUNCTION IF EXISTS public.generate_unique_code_safe CASCADE;
DROP FUNCTION IF EXISTS generate_unique_code_safe CASCADE;

-- Eliminar todas las versiones de get_purchase_request_by_code
DROP FUNCTION IF EXISTS public.get_purchase_request_by_code CASCADE;
DROP FUNCTION IF EXISTS get_purchase_request_by_code CASCADE;
...
-- 4. Crear función de generación de códigos (desde cero)
...
-- 5. Crear función create_purchase_request (versión única y limpia)
...
-- 6. Crear función get_purchase_request_by_code
...
-- =========================================================
-- RESUMEN DE ELIMINACIÓN SIMPLE
-- =========================================================
/*
ELIMINACIÓN SIMPLE COMPLETADA:

1. ✅ Eliminación directa por nombre con CASCADE
2. ✅ Sin problemas con OID
3. ✅ Verificación de eliminación
4. ✅ Recreación desde cero

MÉTODOS APLICADOS:
- DROP FUNCTION por nombre con CASCADE
- Eliminación tanto con schema como sin schema
