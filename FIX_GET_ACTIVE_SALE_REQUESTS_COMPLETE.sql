-- =========================================================
-- SCRIPT COMPLETO PARA CORREGIR get_active_sale_requests
-- Elimina TODAS las versiones y recrea la función correctamente
-- =========================================================
...
BEGIN
    IF EXISTS (
        ...
        RAISE NOTICE '✅ Función get_active_sale_requests creada exitosamente';
    ELSE
