-- =========================================================
-- NMHN - ELIMINACIÓN ULTRA AGRESIVA DE FUNCIONES
-- =========================================================
-- Script ultra agresivo para eliminar TODAS las funciones relacionadas
-- usando múltiples métodos de eliminación
-- =========================================================

-- 1. ELIMINACIÓN POR OID (Método más agresivo)
DO $$
DECLARE
    func_record RECORD;
BEGIN
...
-- 3. Si aún existen funciones, usar eliminación directa por nombre
...
-- 5. Crear función de generación de códigos (desde cero)
...
-- 6. Crear función create_purchase_request (versión única y limpia)
...
-- 7. Crear función get_purchase_request_by_code
...
-- 9. Probar la función de generación de códigos
...
-- =========================================================
-- RESUMEN DE ELIMINACIÓN ULTRA AGRESIVA
-- =========================================================
/*
ELIMINACIÓN ULTRA AGRESIVA COMPLETADA:

1. ✅ Eliminación por OID con CASCADE
2. ✅ Eliminación directa por nombre
3. ✅ Verificación de eliminación completa
4. ✅ Recreación desde cero

MÉTODOS APLICADOS:
- DROP FUNCTION por OID con CASCADE
- DROP FUNCTION directo por nombre
- Verificación múltiple de eliminación
